...
func Run(variant string) {
	path := cmd.InputPath("2024/day15/day15", variant)
	...
	for scanner.Scan() {
		...
		if instSet {
			inst = append(inst, []rune(scanner.Text())...)
			continue
		}
